...
module ColJs {
    ...
    export class Col<E> implements CollectionBase<E> {
        ...
        all(condition:(p1:E)=>boolean):boolean {
            return null;
        }
        ...
        intersect(second:ColJs.Col<E>):ColJs.Col<E> {
            return null;
        }
        ...
        orderByStable(fn:(p1:E)=>number):ColJs.Col<E> {
            return null;
        }

        orderByDescStable(fn:(p1:E)=>number):ColJs.Col<E> {
            return null;
        }
        ...
        take(amount:number):Col<E> {
            var newSource:E[] = this.source.slice(0, amount);
            return Col.of(newSource);
        }
